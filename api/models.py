...
# class AksiyaProduct(BaseField, models.Model):
#     aksiya = models.ForeignKey(Aksiya, on_delete=models.CASCADE)
#     product = models.ForeignKey('Product', on_delete=models.CASCADE)
#     price = models.DecimalField(max_digits=15, decimal_places=2, blank=True, null=True)
#     discount = models.DecimalField(max_digits=15, decimal_places=2, blank=True, null=True)
#     quantity = models.PositiveIntegerField(blank=True, null=True)

class BussinesRegion(BaseField, models.Model):
    name = models.CharField(max_length=100)
    description = models.TextField(blank=True, null=True)
    code = models.CharField(max_length=100, unique=True)
...
class AgentBussinesRegion(BaseField, models.Model):
    agent = models.ForeignKey(CustomUser, on_delete=models.CASCADE)
    region = models.ForeignKey(BussinesRegion, on_delete=models.CASCADE)
